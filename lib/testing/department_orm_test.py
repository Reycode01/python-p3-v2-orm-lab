...
class TestDepartment:
    ...
    def test_creates_table(self):
        ...
        assert CURSOR.execute("SELECT name FROM sqlite_master WHERE type='table' AND name='departments'").fetchone() is not None
    ...
    def test_updates_row(self):
        ...
        assert (department.id, department.name, department.location) == (department1.id, department1.name, department1.location)
        ...
        assert (department.id, department.name, department.location) == (department2.id, department2.name, department2.location)
    ...
    def test_deletes_row(self):
        ...
        assert (None, "Sales and Marketing", "Building B, 4th Floor") == (department2.id, department2.name, department2.location)
    ...
    def test_get_employees(self):
        '''contains a method "employees" that gets the employees for the current Department instance'''
        Employee.all = {}
        Department.create_table()
